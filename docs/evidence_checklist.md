...
* \[ ] Modelo ONNX subido a `models/nutrition\_model.onnx`.
* \[ ] Datos de prueba subidos a `datasets/nutrition\_test\_data.csv`.
* \[ ] Archivo `logs/predicciones\_dev.txt` creado o generado por endpoint dev.
* \[ ] Archivo `logs/predicciones\_prod.txt` creado o generado por endpoint prod.
